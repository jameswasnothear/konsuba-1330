...
function swiching_charicters () {
    ...
    if (CodeSequence == 1) {
        ...
        darkness.setKind(SpriteKind.Player)
        MIGAMII.setKind(SpriteKind.follower)
        aqua.setKind(SpriteKind.follower)
        statusbar.attachToSprite(darkness)
        scene.cameraFollowSprite(darkness)
        music.magicWand.play()
    } else if (CodeSequence == 2) {
        controller.moveSprite(MIGAMII)
        darkness.setKind(SpriteKind.follower)
        MIGAMII.setKind(SpriteKind.Player)
        aqua.setKind(SpriteKind.follower)
        ...
        darkness.setKind(SpriteKind.follower)
        MIGAMII.setKind(SpriteKind.follower)
        aqua.setKind(SpriteKind.Player)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorOpenNorth, function (sprite, location) {
    ...
    darkness.setPosition(5, 120)
    aqua.setPosition(5, 120)
    MIGAMII.setPosition(5, 120)
})
...
tiles.createSpritesOnTiles(sprites.dungeon.doorOpenNorth, SpriteKind.dungeonentrance1)
